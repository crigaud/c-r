...
?>
	...
	<ul class="menuTop">
		...
		<li class="ball_1">
			<a href="http://<?php echo $_SERVER['SERVER_NAME'].'/'.$lang; ?>/" onclick="setStyle1(1);"><?php echo $global['ME_HOME'] ?></a>
		</li>
		<li class="ball_2">
			<a href="http://<?php echo $_SERVER['SERVER_NAME'].'/'.$lang; ?>/cv/" onclick="setStyle1(2);"><?php echo $global['ME_RESUME'] ?></a>
		</li>
		<li class="ball_3">
			<a href="http://<?php echo $_SERVER['SERVER_NAME'].'/'.$lang; ?>/contact/" onclick="setStyle1(3);"><?php echo $global['ME_CONTACT'] ?></a>
		</li>
	</ul>
</div>
