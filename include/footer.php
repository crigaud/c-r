<footer>	
	...
	<p>
			...
			<a href="http://validator.w3.org/check?uri=http://<?php echo $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']; ?>"  onclick="window.open(this.href); return false;" title="Valid HTML5"><img src="http://<?php echo $_SERVER['SERVER_NAME']?>/icon/logo_validation_w3c_HTML_5.png" alt="HTML_5"/></a>
			<a rel="license" href="http://creativecommons.org/licenses/by/3.0/">Creative Commons License</a> 2010 - <?php echo '' . date('Y') ?>
						<a href="http://jigsaw.w3.org/css-validator/validator?uri=http://www.christophe-rigaud.com&amp;profile=css3" onclick="window.open(this.href); return false;" title="Valid CSS3"><img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/icon/logo_validation_w3c_css_level_3.png" alt="logo_css_3"/></a>
