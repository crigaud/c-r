...
// 		die;
	...
	if( $test1 == 1 || $test2 == 1){
		if($test1 == 1 && $test2 == 0){
			header("Location: http://".$_SERVER['SERVER_NAME'].'/'.LANGUAGE."/contact/?t1=1");
			die;
		}else if($test1 == 0 && $test2 == 1){
			header("Location: http://".$_SERVER['SERVER_NAME'].'/'.LANGUAGE."/contact/?t2=1");
			die;
		}else {
			header("Location: http://".$_SERVER['SERVER_NAME'].'/'.LANGUAGE."/contact/?t1=1&t2=1");
			die;
		}
