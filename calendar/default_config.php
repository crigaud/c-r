...
// Define some magic strings.
		...
		$this->auth_internal_username	= 'mbz';			// Only used if $this->auth_method='internal'. The username for the administrator.
		$this->auth_internal_password	= '&aq1AQ&aq';		// Only used if $this->auth_method='internal'. The password for the administrator.
